...
| part | cm³ | was called |
|---|---:|---|
| `ST-01-Core-Tube` | 344.50 | `CoreBox_cut` |
| `ST-02-Backplate` | 9.64 | `Backplate_1-8` |
| `ST-03-Backplate-Boss-L` | 3.24 | `BP_Boss_R_1-2` |
| `ST-03-Backplate-Boss-R` | 3.24 | `BP_Boss_L_1-2` |
| `ST-04-Barrel-Plate` | 16.04 | `Barrel_Plate_1-4` |
| `ST-05-Barrel-Socket` | 42.39 | `Barrel_Socket_1-5x156` |
| `ST-06-Cover-Spine` | 26.19 | `Hatch_Spine_1-8` |
| `ST-07-Hinge-Tab-L` | 5.55 | `Hinge_Tab_R_1-8` |
| `ST-07-Hinge-Tab-R` | 5.55 | `Hinge_Tab_L_1-8` |
| `ST-08-Pintle-Tab-L` | 26.25 | `Pintle_Tab_R_1-2` |
| `ST-08-Pintle-Tab-R` | 26.25 | `Pintle_Tab_L_1-2` |

## Hardware — buy

| part | what | was called |
|---|---|---|
| `HW-01-Barrel-EMT-1in` | 1" EMT conduit, the barrel | `Barrel_EMT_1in` |
| `HW-02-Switch-SS5GL13` | trigger microswitch | `REF_Switch_SS5GL13` |
| `HW-03-Trigger-Pin-4mm` | ⌀4 trigger pivot pin | `REF_PivotPin_4mm` |

## Printed

| part | faces | cm³ | was called |
|---|---:|---:|---|
| `PR-11-Side-Rear-L` | 162 | 201.43 | `Side_R1` |
| `PR-12-Side-Rear-R` | 262 | 328.35 | `Side_L1` |
| `PR-13-Side-Front-L` | 75 | 122.16 | `Side_R2` |
| `PR-14-Side-Front-R` | 84 | 133.95 | `Side_L2` |
| `PR-15-Top-Deck` | 61 | 468.72 | `Top1` |
| `PR-16-Top-Cover` | 138 | 510.84 | `Hatch` |
| `PR-17-Front-Sight-Boss` | 304 | 106.29 | `FrontBoss` |
| `PR-18-Bottom-Rear` | 181 | 279.13 | `Bot1` |
| `PR-19-Bottom-Front-L` | 30 | 3.65 | half of `Bot2` |
| `PR-19-Bottom-Front-R` | 30 | 3.65 | half of `Bot2` |
| `PR-21-Barrel-Jacket` | 60 | 638.00 | `Barrel_Jacket` |
| `PR-31-Spade-Grips` | 1,463 | 330.61 | `Grip_Assembly` |
| `PR-41-CH-Handle` | 73 | 116.82 | `CH_Handle` |
| `PR-42-CH-Carrier` | 33 | 13.27 | `CH_Carrier` |
| `PR-43-CH-Shoe` | 8 | 3.96 | `CH_Shoe` |
| `PR-51-Trigger-Butterfly` | 611 | 32.78 | `Trigger` |
| `PR-52-Trigger-Switch-Carrier` | 52 | 23.10 | `Trigger_Switch_Carrier` |
| `PR-61-Engine-Cradle` | 30 | 181.08 | `Cradle_F2_HopUp` |
